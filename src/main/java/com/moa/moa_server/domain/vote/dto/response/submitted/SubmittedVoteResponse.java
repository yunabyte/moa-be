...
public record SubmittedVoteResponse(
    @Schema(description = "투표 목록") List<SubmittedVoteItem> votes,
    @Schema(
  ...
  public static SubmittedVoteResponse of(
      List<SubmittedVoteItem> votes, String nextCursor, boolean hasNext) {
